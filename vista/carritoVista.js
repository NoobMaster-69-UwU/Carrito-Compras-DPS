    ...
    mostrarCarrito(productos, total, incrementarProducto, decrementarProducto, eliminarProducto) {
        ...
        productos.forEach((producto) => {
            ...
            productoElemento.innerHTML = `
                ...
                <div class="acciones">
                    <button class="btn-decremento btn btn-primary" data-id="${producto.id}">-</button>
                    <button class="btn-incremento btn btn-primary" data-id="${producto.id}">+</button>
                    <button class="btn-eliminar btn btn-danger" data-id="${producto.id}">X</button>
                </div>
                </div>
            `;
